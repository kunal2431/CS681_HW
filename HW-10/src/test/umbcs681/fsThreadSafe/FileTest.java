...
public class FileTest{
    ...
    private String[] fileToStringArray(RunnableFile f){
    ...
    public void verifyFile_getFiles(){
        LinkedList<RunnableFile> actual = test.getFiles();
    ...
    public void verifyFileEqualityCheck_ATest_java(){
        ...
        assertTrue(ATest instanceof RunnableFile);
    ...
    public void verifyFileEqualityCheck_B_java(){
        ...
        assertTrue(B instanceof RunnableFile);
